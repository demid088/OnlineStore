      ...
      <div className="container-xxl p-0 pt-5">
        <div className="row row-cols-1 row-cols-lg-2 align-items-center text-bg-light pt-lg-5 pb-4 bg-transparent">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  ...
                  <div className="col-8 col-lg-10 ms-auto">
          ...
          <div className="col text-center text-uppercase pt-4 pt-lg-5 px-5">
            ...
            <div class="input-group w-auto mt-4 mx-5">
              <input type="text" class="form-control bg-light" placeholder="Enter Your Email" aria-label="Enter Your Email" aria-describedby="btnGroupAddon" />
